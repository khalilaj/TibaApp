...
public class CustomerMapsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, com.google.android.gms.location.LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDriverInfo = (LinearLayout) findViewById(R.id.paediatricianInfo);
        mDriverName = (TextView) findViewById(R.id.paediatricianName);
        mDriverPhone = (TextView) findViewById(R.id.paediatricianPhone);

        mDriverCar = (TextView) findViewById(R.id.paediatricianCar);
        mDriverProfileImage = findViewById(R.id.paediatricianProfileImage);
        ...
        mLogout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(CustomerMapsActivity.this, UserOptionsActivity.class);
